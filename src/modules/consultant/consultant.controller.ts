...
export class ConsultantController {
    ...
    @ApiOperation({
        ...
        description: 'Gợi ý 2-3 sản phẩm phù hợp với dịp và phong cách. Dùng cho intent: ask_styling_advice',
    })
    ...
    @ApiOperation({
        ...
        description: 'Tính toán size phù hợp dựa trên chiều cao/cân nặng. Dùng cho intent: ask_sizing_advice',
    })
    ...
    @ApiOperation({
        ...
        description: 'So sánh 2-3 sản phẩm về giá, chất liệu, rating. Dùng cho intent: ask_product_comparison_contextual',
    })
