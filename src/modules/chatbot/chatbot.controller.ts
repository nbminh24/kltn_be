...
export class ChatbotController {
  ...
  @ApiOperation({
    ...
    description:
      'Internal API for Rasa chatbot to retrieve customer cart. Returns cart items with product details, variants, and totals.',
  })
  @ApiParam({
    name: 'customer_id',
  ...
  @ApiOperation({
    ...
    description:
      'Internal API for Rasa chatbot to add items to customer cart. Validates customer and stock before adding.',
  })
  @ApiResponse({
    status: 201,
  ...
  @ApiOperation({
    ...
    description:
      'Internal API for Rasa chatbot to cancel customer orders. Only pending orders can be cancelled.',
  })
  @ApiParam({
    name: 'id',
  ...
  async cancelOrder(@Param('id') orderId: string, @Body() dto: CancelOrderInternalDto) {
  ...
  @ApiOperation({
    ...
    description:
      'Returns size chart image URL for specific product category (shirt, pants, shoes).',
  })
  @ApiParam({
    name: 'category',
  ...
  @ApiOperation({
    ...
    description:
      'Get size recommendation based on customer height and weight. Returns recommended size with confidence level.',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      'Search products by name/description keywords. Prioritizes products matching all keywords over partial matches.',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      'Get product recommendations based on context/occasion (wedding, beach, work, party, casual, sport). Uses JSONB attributes to match products.',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      'Internal API for Rasa chatbot to verify JWT token and get customer information. Returns customer_id and profile data.',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      'Ask Google Gemini AI for questions outside chatbot scope (fashion advice, style tips, etc.). Returns AI-generated answer with fallback handling.',
  })
  @ApiResponse({
    status: 200,
