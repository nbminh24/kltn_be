...
export class CancelOrderDto {
  ...
  @IsEnum(CancelReason, {
    message:
      'Invalid cancellation reason. Must be one of: changed_mind, ordered_wrong_item, wrong_size_color, found_better_price, delivery_too_slow, payment_issue, duplicate_order, other',
  })
  @IsNotEmpty()
