...
export class DeliveryEstimationService {
    ...
    isMajorCity(city: string): boolean {
        ...
        return this.MAJOR_CITIES.some(majorCity =>
    ...
    getDeliveryStatusMessage(status: string): string {
        const messages = {
            pending: 'Your order is pending confirmation. Delivery date will be available once confirmed.',
            confirmed: 'Your order is confirmed and being prepared. Delivery estimate will be available once shipped.',
